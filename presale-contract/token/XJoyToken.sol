...
contract XJoyToken is BlackListToken {
    ...
    function isTransferable(address _from, address _to, uint256 _amount) public view virtual override returns (bool) {
        ...
        require(isWhiteListed[_from] || isWhiteListed[_to] || (!isLockedInPrivatePresale && !isLockedInSeedPresale), "XJoyToken@isTransferable: _from is in locked in presale SC");
